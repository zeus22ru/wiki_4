...
- Настраивать стиль ответа, количество источников и минимальную релевантность прямо в интерфейсе
...
- Загружать документы, смотреть список файлов и запускать переиндексацию во вкладке «База знаний»
- Смотреть состояние LLM, Chroma, моделей и RAG-настроек во вкладке «Админка»
